...
public class RouteMainPanel extends JPanel implements ActionListener{
    ...
    private boolean validateInputFields() {
        ...
        if (source.getText().isEmpty()
                && sourceAddress1.getText().isEmpty() && sourceAddress2.getText().isEmpty() && destinationAddress1.getText().isEmpty() &&  destinationAddress2.getText().isEmpty()
                && rateDescription.getText().isEmpty() && !ConstantFunctions.isNumeric(rateValue.getText())){
    ...
    public Route convertToRoute() {
        ...
        Rate rate = new Rate(rateDescription.getText(), value);
